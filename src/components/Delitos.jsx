  ...
  return (
    <div className="bg-white rounded-lg shadow-lg max-w-4xl mx-auto p-8 mb-12">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Tipificación de Delitos Informáticos (Ley 21.459)</h1>
      </div>
      ...
      {/* Acción 1 */}
      <div className="bg-slate-50 border border-gray-200 rounded-md p-6 mb-6">
        <div className="mb-4">
