  ...
  return (
    <div className="bg-white rounded-lg shadow-lg max-w-4xl mx-auto p-8 mb-12">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-800">Responsabilidades Legales de los Actores</h1>
      </div>
      ...
      <div className="mb-8">
        <div className="bg-slate-800 text-white p-3 rounded-t-md">
          <h2 className="text-2xl font-bold">Los Cibercriminales (Atacantes)</h2>
        </div>
        <div className="border border-slate-200 p-5 rounded-b-md mb-6">
      ...
      {/* Bloque 2: Riot Games */}
      <div className="mb-8">
        <div className="bg-emerald-700 text-white p-3 rounded-t-md">
